...
const STACK = [
  ...
  { x: -54, y: 18, rot: -12, sc: 0.95 }, // 왼쪽 아래로 삐죽
  { x: 52, y: -4, rot: 7, sc: 0.93 }, // 오른쪽 위로 삐죽
  { x: -34, y: -14, rot: -8, sc: 0.91 }, // 왼쪽 위 모서리
  { x: 32, y: 24, rot: 5, sc: 0.89 }, // 아래쪽으로 한 겹 더
];
        ...
        <div className="viewport" ref={viewportRef}>
          ...
          <div className={"screen" + (screen === "my" ? " active" : "")} id="s-my">
            <div className="myhero">
              ...
              <div className="mysub">{myGroups.length}그룹과 함께 와키 중</div>
            </div>
            <div className="cal">
              <h4>{calMonthNum}월</h4>
